        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    ...
                    URL url = new URL("http://192.168.43.213:8080/FoodEmblemV1-war/Resources/Promotion/retrieveRestaurantPromoFromBeacon/" + major + "/" + minor);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String jsonString) {
                try {
                    if (!jsonString.equals("{}")){
                        JSONObject jsonObject = new JSONObject(jsonString);
                        major = jsonObject.getJSONObject("reservationSeating").getInt("major");
                        minor = jsonObject.getJSONObject("reservationSeating").getInt("minor");
