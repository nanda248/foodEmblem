        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                try {
                    ...
                    URL url = new URL("http://192.168.43.213:8080/FoodEmblemV1-war/Resources/Customer/AddCustomerOrder");
    ...
    public void loadPromotion(final int restid){
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    System.err.println("**** Calling rest web service");
                    URL url = new URL("http://192.168.43.213:8080/FoodEmblemV1-war/Resources/Promotion/getPromotionByRestaurantId/" + restid);
                    // http://localhost:3446/FoodEmblemV1-war/Resources/Sensor/getFridgesByRestaurantId/1
                    HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
